...
function getInspired(keyWords){
	...
	var url = "https://api.stackexchange.com/2.2/tags/"+keyWords+"/top-answerers/all_time?site=stackoverflow"
	var tag = keyWords;
...
function showSearch(key,num){
	var resultText = num +' result for <strong>'+key+'</strong>'
	return resultText;
}
